...
def make_channel_dict(
        ...
        *,
        ...
        recipients: list[_types.JsonDict] = ...,
        icon: str | None = ...,
        owner_id: int = ...,
        application_id: int = ...,
        parent_id: int | None = ...,
...
def make_message_dict(
        ...
        mention_channels: list[_types.AnyChannel] = ...,
...
def make_guild_dict(
        name: str,
        owner_id: int,
        roles: list[_types.JsonDict],
        id_num: int = ...,
        emojis: list[_types.JsonDict] = ...,
        icon: str | None = ...,
        splash: str | None = ...,
        region: str = ...,
        afk_channel_id: int = ...,
        ...
        *,
        ...
        unavailable: bool = ...,
        member_count: int = ...,
        voice_states: list[discord.VoiceState] = ...,
        members: list[discord.Member] = ...,
        channels: list[discord.abc.GuildChannel] = ...,
        presences: list[discord.Activity] = ...,
) -> _types.JsonDict: ...
...
def make_guild_dict(
        ...
        roles: list[_types.JsonDict],
        id_num: int = -1,
        emojis: list[_types.JsonDict] | None = None,
        icon: str | None = None,
