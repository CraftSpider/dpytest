...
def make_member_dict(guild: discord.Guild, user: discord.User, roles: List[int], joined: int = ..., deaf: bool = ..., mute: bool = ...,
                     nick: str = ...) -> JsonDict: ...
...
def dict_from_overwrite(target: Union[discord.Member, discord.Role], overwrite: discord.PermissionOverwrite) -> JsonDict: ...
...
def dict_from_guild(guild: discord.Guild) -> JsonDict: ...
