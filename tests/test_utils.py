...
@pytest.mark.asyncio
async def test_embed_eq_direct(bot: commands.Bot) -> None:
    embed_1: Embed = Embed()
    embed_2: Embed = Embed()
...
@pytest.mark.asyncio
async def test_embed_eq_embed1_is_none(bot: commands.Bot) -> None:
    embed_2: Embed = Embed()
    assert embed_eq(None, embed_2) is False


@pytest.mark.asyncio
async def test_embed_eq_embed2_is_none(bot: commands.Bot) -> None:
    embed_1: Embed = Embed()
    assert embed_eq(embed_1, None) is False


@pytest.mark.asyncio
async def test_embed_eq_attr_title(bot: commands.Bot) -> None:
...
@pytest.mark.asyncio
async def test_embed_eq_attr_description(bot: commands.Bot) -> None:
...
@pytest.mark.asyncio
async def test_embed_eq_attr_url(bot: commands.Bot) -> None:
...
@pytest.mark.asyncio
async def test_embed_eq_attr_footer(bot: commands.Bot) -> None:
    embed_1: Embed = Embed(title="Foo", description="This is a Foo.", url="http://www.foo.foo")
...
@pytest.mark.asyncio
async def test_embed_eq_attr_image(bot: commands.Bot) -> None:
    embed_1: Embed = Embed(title="Foo", description="This is a Foo.", url="http://www.foo.foo")
    embed_1.set_footer(text="This is the footer for Foo.")
...
@pytest.mark.asyncio
async def test_embed_eq_attr_fields(bot: commands.Bot) -> None:
    embed_1: Embed = Embed(title="Foo", description="This is a Foo.", url="http://www.foo.foo")
    embed_1.set_footer(text="This is the footer for Foo.")
    embed_1.set_image(url="http://image.foo")
...
@pytest.mark.asyncio
async def test_embed_eq_attr_equal(bot: commands.Bot) -> None:
    embed_1: Embed = Embed(title="Foo", description="This is a Foo.", url="http://www.foo.foo")
    embed_1.set_footer(text="This is the footer for Foo.")
    embed_1.set_image(url="http://image.foo")
    embed_1.add_field(name="Foo", value="Foo")
